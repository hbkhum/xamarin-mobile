...
{
    public class TruckListViewModel : ValidatableBindableBase, ITruckListViewModel
    {
        ...
        public Truck SelectedTruck
        {
            set
            {
                ...
                var truckPageDetail = new TruckDetailView()
                {
                    BindingContext = _truckViewModel
                };
                page?.PushAsync(truckPageDetail);
                SelectedTruck = null;
            }
            get => _selectedTruck;
        }
